...
{% hint style="success" %}
OneClick is the recommended app for M-series Macs. It is easy to setup. If you have an Intel Mac, please use [ClashX](../../mac-os/clashx-meta.md) instead. ClashX is just as stable and performant, but takes a little more time to set up.
{% endhint %}
